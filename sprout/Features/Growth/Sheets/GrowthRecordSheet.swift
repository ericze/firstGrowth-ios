...
struct GrowthRecordSheet: View {
    ...
    var body: some View {
        BaseRecordSheet(
            title: store.textRenderer.metricEntryTitle(store.viewState.sheetState.metric ?? store.viewState.currentMetric),
            ...
            SheetPrimaryButton(
                title: L10n.text("common.done_record", en: "Done", zh: "完成记录"),
