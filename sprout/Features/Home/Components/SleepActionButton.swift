    ...
    var body: some View {
        Button(action: handleTap) {
            VStack(spacing: 4) {
                ...
                Text(isActive ? String(localized: "home.sleep.action.active") : String(localized: "home.sleep.action.inactive"))
            ...
            .overlay(alignment: .top) {
                if showHint {
                    SleepHintBubble(text: String(localized: "home.sleep.hint.end"))
                        .offset(y: -34)
        ...
        .accessibilityLabel(isActive ? String(localized: "home.sleep.accessibility.active") : String(localized: "home.sleep.accessibility.start"))
        .accessibilityValue(isActive ? String(localized: "home.sleep.accessibility.in_progress") : String(localized: "home.sleep.accessibility.not_started"))
        .onDisappear {
