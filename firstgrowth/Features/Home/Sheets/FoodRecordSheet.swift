...
struct FoodRecordSheet: View {
    ...
    var body: some View {
        BaseRecordSheet(title: "记辅食", onClose: { store.requestFoodDismiss() }) {
            ...
            SheetPrimaryButton(title: "完成记录", isEnabled: store.isFoodSaveEnabled) {
        ...
        .confirmationDialog("放弃这条辅食记录？", isPresented: Binding(
